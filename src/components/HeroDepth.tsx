...
export function HeroDepth({ className = "" }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden
    >
      {/* Soft forest-green elliptical bloom — centered behind the headline */}
      <div
        className="absolute left-1/2 top-[36%] h-[min(70vw,520px)] w-[min(96vw,860px)] -translate-x-1/2 -translate-y-1/2"
        style={{
          background:
            "radial-gradient(ellipse 68% 52% at 50% 50%, rgba(34,139,90,0.16) 0%, rgba(34,139,90,0.06) 38%, rgba(34,139,90,0.02) 58%, transparent 74%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(34,139,90,0.07) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(34,139,90,0.055) 0%, transparent 72%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, rgba(34,139,90,0.22) 30%, rgba(244,244,245,0.08) 50%, rgba(34,139,90,0.22) 70%, transparent 100%)",
        }}
      />
